      ...
      {loading ? (
        ...
        <div className="news-list">
          ...
          <div className="sim-target-card">
            ...
            <div className="sim-feat-grid">
              <div className="sim-feat">
                <span className="sim-feat-label">情感得分</span>
              ...
              <div className="sim-feat">
                <span className="sim-feat-label">新闻篇数</span>
                <span className="sim-feat-val">{data.target_features.n_articles ?? 0}</span>
              </div>
              <div className="sim-feat">
                <span className="sim-feat-label">RSI指标</span>
          ...
          <div className="sim-stats-card">
            <div className="sim-section-label">历史模式 ({data.stats.count} 个相似交易日)</div>
            <div className="sim-stats-grid">
              <div className="sim-stat-block">
                <span className="sim-stat-title">次日上涨率</span>
              ...
              <div className="sim-stat-block">
                <span className="sim-stat-title">次日平均收益</span>
              ...
              <div className="sim-stat-block">
                <span className="sim-stat-title">T+5 平均收益</span>
            ...
            <div key={day.date} className="sim-day-card">
              ...
              <div className="sim-day-details">
                <span className={`sim-day-chip ${day.sentiment_score >= 0 ? 'up' : 'down'}`}>
                  情感 {day.sentiment_score.toFixed(2)}
                </span>
